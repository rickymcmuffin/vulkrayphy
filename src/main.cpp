...
#define GLM_ENABLE_EXPERIMETNAL
#include <glm/glm.hpp>
...
class HelloTriangleApplication
{
  ...
  private:
    ...
    void initWindow()
    {
        ...
        window =
            glfwCreateWindow(WIDTH, HEIGHT, "VulkRayPhy", nullptr, nullptr);
    ...
    void drawFrame()
    {
        ...
        vkResetCommandBuffer(commandBuffers[currentFrame], imageIndex);
    ...
    void createTextureImage()
    {
        ...
        VkBuffer stagingBuffer;
        VkDeviceMemory stagingBuferMemory;

        createBuffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
                     VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
                         VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
                     stagingBuffer, stagingBuferMemory);

        void *data;
        vkMapMemory(device, stagingBuferMemory, 0, imageSize, 0, &data);
        memcpy(data, pixels, static_cast<size_t>(imageSize));
        vkUnmapMemory(device, stagingBuferMemory);
        ...
        vkDestroyBuffer(device, stagingBuffer, nullptr);
        vkFreeMemory(device, stagingBuferMemory, nullptr);
    }
